...
.DATA
	...
	INPUT_BOOK_TITLE DB "Please enter the book title: $"
	D_TITLE DB "TITLE : $"
	D_PRICE DB "PRICE : $"
	...
	HEARDER_SEARCH_MENU DB "MENU$"
	HEARDER_SEARCH_TITLE DB "SEARCH BY BOOK TITLE$"
	HEARDER_SEARCH_GENRE DB "SEARCH BY BOOK GENRE$"
	HEARDER_SEARCH_AUTHOR DB "SEARCH BY BOOK AUTHOR$"
	HEARDER_SEARCH_ALL DB "ALL BOOK$"
	QUE1 DB "Enter your choice: $"
	QUE2 DB "Enter your choice (Enter 1 for Horror): $"
	QUE3 DB "Do you want to search for another? : $"
	QUE4 DB "Please enter the author last name (LOKE XIN YEE = LOKE): $"
	...
	Price DD OFFSET 10.5, OFFSET 25.3, OFFSET 16.0, OFFSET 17.9, OFFSET 10.5, OFFSET 12.2, OFFSET 13.0, OFFSET 15.4
